...
# Function to generate the Makefile for main.c and its traceable version
generate_makefile() {
    ...
    # Generate rules for server.c
    echo "server: server.c" >> Makefile
    echo -e "\t\$(CC) \$(COMPILATION_FLAGS) \$(CFLAGS) \$(SUPPORTED_FLAGS) \$(SUPPORTED_SANITIZER_FLAGS) -o server server.c \$(LIBRARIES)" >> Makefile
    echo "PROGRAMS += server" >> Makefile

    echo "server-traceable: server.c" >> Makefile
    echo -e "\t\$(CC) \$(COMPILATION_FLAGS) \$(CFLAGS) \$(SUPPORTED_FLAGS) -o server-traceable server.c \$(LIBRARIES)" >> Makefile
    echo "PROGRAMS += server-traceable" >> Makefile

    # Generate rules for client.c
    echo "client: client.c" >> Makefile
    echo -e "\t\$(CC) \$(COMPILATION_FLAGS) \$(CFLAGS) \$(SUPPORTED_FLAGS) \$(SUPPORTED_SANITIZER_FLAGS) -o client client.c \$(LIBRARIES)" >> Makefile
    echo "PROGRAMS += client" >> Makefile

    echo "client-traceable: client.c" >> Makefile
    echo -e "\t\$(CC) \$(COMPILATION_FLAGS) \$(CFLAGS) \$(SUPPORTED_FLAGS) -o client-traceable client.c \$(LIBRARIES)" >> Makefile
    echo "PROGRAMS += client-traceable" >> Makefile
...
# Generate Makefile for runner and runner-traceable
generate_makefile
